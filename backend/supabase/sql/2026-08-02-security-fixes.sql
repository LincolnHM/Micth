...
--      la Edge Function backend/supabase/functions/create-order para frenar spam de
--      pedidos.
--
...
-- puede tocarla (mismo patrón que ya usas en check_dni_exists, js/store/customer-auth.js).
...
-- la Edge Function. Cuando confirmes que backend/supabase/functions/create-order está
