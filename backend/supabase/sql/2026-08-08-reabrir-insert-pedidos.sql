...
-- desplegar primero backend/supabase/functions/create-order (con Supabase CLI) y
-- CONFIRMAR con un pedido real que llega al panel admin antes de volver a
-- correr backend/supabase/sql/2026-08-04-cerrar-insert-directo.sql. Avísame cuando
