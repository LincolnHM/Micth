...
async function saveCombo() {
  ...
  if (_comboSelectedItems.length < 2) { showToast('Agrega al menos 2 perfumes al combo.'); return; }
  ...
  if (!Object.keys(prices).length) { showToast('Pon el precio del combo en al menos una talla.'); return; }
